    ...
    <div className="flex flex-col sm:flex-row items-center justify-between gap-3 px-5 py-3.5 bg-white border border-gray-200/80 rounded-2xl shadow-2xs mt-6">
      <div className="flex items-center gap-3 flex-wrap">
        <p className="text-xs text-gray-500 font-medium">
          Showing <span className="font-bold text-gray-900">{pageStart}</span>–<span className="font-bold text-gray-900">{pageEnd}</span> of <span className="font-bold text-gray-900">{totalCount}</span> cases
        </p>
