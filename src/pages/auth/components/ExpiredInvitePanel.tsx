    ...
    <>
      <div className="flex flex-col items-center text-center p-5 bg-amber-50 border border-amber-100 rounded-xl mb-6">
        ...
        <p className="text-[12px] text-amber-700 leading-relaxed">
          Setup links are valid for <strong>24 hours</strong>. This link has expired or already been used.
        </p>
      </div>

      <div className="bg-gray-50 border border-gray-100 rounded-xl p-5">
        <p className="text-[13px] font-semibold text-gray-800 mb-1">Request a new setup link</p>
        <p className="text-[12px] text-gray-500 mb-4 leading-relaxed">
          Enter your login phone number or work email below. An administrator will be notified to send you a fresh link.
        </p>
        <form onSubmit={handleRequest} className="space-y-3">
          ...
          >
            {status === "loading" ? (
              ...
              <>
                <i className={isPhone ? "ri-telegram-fill text-base" : "ri-mail-send-line"} />
                <span>Request Fresh Link</span>
              </>
            )}
          </button>
        </form>
