...
const EMPLOYEE_SCOPED_MODULES = new Set(["leave", "shifts", "payroll", "headcount", "daily-logs", "meeting-rooms", "onboarding", "onboarding-tasks", "attendance", "attendance-summary"]);
