...
export default function FinancePage() {
  const {
    canManage, isSuperAdmin, isPartnerBranchBlocked, userBranchId, targetBranch,
    branchPolicy, actorName, expenses, branches, loading, selectedExpense,
    setSelectedExpense, searchQuery, setSearchQuery, categoryFilter, setCategoryFilter,
    statusFilter, setStatusFilter, branchFilter, setBranchFilter, datePreset,
    setDatePreset, fromDate, setFromDate, toDate, setToDate, viewMode, setViewMode,
    pageSize, setPageSize, page, setPage, filtered, totalPages, pageStart, pageEnd,
    pagedExpenses, totalAmount, paidAmount, approvedAmount, pendingAmount,
    categoryChartData, monthlyTimelineData, modal, setModal, policyModalOpen,
    setPolicyModalOpen, editingExpense, setEditingExpense, saving, savingPolicy,
    expenseForm, setExpenseForm, updateStatus, handleCreateExpense, openEditModal,
    handleSaveEdit, handleDeleteExpense, handleSavePolicy, handleExportCSV,
  } = useFinance();
    ...
    return (
      <div className="min-h-screen bg-[#F8F9FB] dark:bg-slate-900 p-5 sm:p-7 lg:p-8 font-sans">
        ...
        <PartnerBranchPrivacyShield
          moduleName="Branch Financial Ledgers &amp; Budgets"
