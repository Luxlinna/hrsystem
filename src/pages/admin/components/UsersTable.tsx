        ...
        <div className="divide-y divide-gray-50 dark:divide-slate-800">
          {displayedUsers.map((user) => {
            ...
            return (
              <div
                key={user.id}
                className="flex flex-wrap items-center justify-between gap-3.5 px-5 py-4 hover:bg-gray-50/50 dark:hover:bg-slate-800/50 transition-colors"
              >
                {/* User Info & Identity */}
                ...
                <div className="shrink-0">
                  {hasConfirmedAccount && hasRoleAssigned ? (
                    <span
                      className="inline-flex items-center gap-1.5 text-xs font-semibold px-3 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800/60 shadow-2xs whitespace-nowrap"
                    ...
                    <span
                      className="inline-flex items-center gap-1.5 text-xs font-semibold px-3 py-1 rounded-full bg-amber-50 dark:bg-amber-950/60 text-amber-800 dark:text-amber-300 border border-amber-300 dark:border-amber-800/60 shadow-2xs whitespace-nowrap"
                    ...
                    <span
                      className="inline-flex items-center gap-1.5 text-xs font-semibold px-3 py-1 rounded-full bg-amber-50 dark:bg-amber-950/60 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800/60 shadow-2xs whitespace-nowrap"
                    ...
                    <span
                      className="inline-flex items-center gap-1.5 text-xs font-medium px-3 py-1 rounded-full bg-gray-100 dark:bg-slate-800 text-gray-500 dark:text-slate-400 border border-gray-200 dark:border-slate-700 whitespace-nowrap"
              ...
              <div className="p-6 space-y-4">
                <div className="p-4 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200/80 dark:border-emerald-800/60 flex items-start gap-3">
                  ...
                  <div className="text-xs text-emerald-900 dark:text-emerald-200">
                    <p className="font-bold text-sm text-emerald-950 dark:text-emerald-100 mb-0.5">
                ...
                <div className="bg-gray-50 dark:bg-slate-800/60 border border-gray-200 dark:border-slate-700 rounded-xl p-4 space-y-2 text-xs">
                  ...
                  <div className="flex justify-between items-center pt-2 border-t border-gray-200 dark:border-slate-700">
                    ...
                    <span className="font-mono font-bold text-[#253C7D] dark:text-sky-300">
                      {newPhonePassword}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-3 rounded-xl bg-gray-50 dark:bg-slate-800/60 border border-gray-200 dark:border-slate-700 text-xs flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-gray-500 dark:text-slate-400 flex items-center gap-1 mt-0.5">
                      ...
                      <span className="font-semibold text-gray-700 dark:text-slate-200">{syntheticEmailToPhone(phoneModalUser.email)}</span>
                    </p>
                  </div>
