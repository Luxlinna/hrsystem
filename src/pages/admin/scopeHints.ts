export const SCOPE_HINTS: Record<string, string> = {
  ...
  candidate_approval_ceo_sign: "Candidate Approval Step 1: Sign on behalf of BU CEO / Division Director (or authorized delegate).",
  candidate_approval_hr_sign: "Candidate Approval Step 2: Sign on behalf of HR and Admin Manager (or authorized HR staff).",
  candidate_approval_director_sign: "Candidate Approval Step 3: Sign on behalf of HR&Admin Division Director.",
