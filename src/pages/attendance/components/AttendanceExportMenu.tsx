    ...
    async (fmt: Format) => {
      ...
      try {
        if (activeTab === "summary" || activeTab === "live") {
          ...
          if (fmt === "pdf") exportAttendanceRecordsPDF(records);
          else if (fmt === "xlsx") await exportAttendanceRecordsXLSX(records);
          else if (fmt === "csv") exportAttendanceRecordsCSV(records);
        }
      } finally {
        setTimeout(() => setExporting(null), 700);
      }
    },
    [activeTab, records, summaries]
  );
  ...
  const exportOptions = [
    {
      ...
      ext: ".pdf",
      desc: "Print-ready summary with check-in metrics & table",
    ...
    },
    {
      ...
      ext: ".xlsx",
      desc: "Detailed timesheet and check-in spreadsheet",
    ...
    },
    {
      ...
      ext: ".csv",
      desc: "Raw comma-separated attendance log file",
