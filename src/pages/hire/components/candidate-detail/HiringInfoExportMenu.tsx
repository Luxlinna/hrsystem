...
import { exportHiringInfoPdf } from "../../exports/exportHiringInfoPdf";
import { exportHiringInfoWord } from "../../exports/exportHiringInfoWord";

interface HiringInfoExportMenuProps {
  candidate: Candidate;
}

export const HiringInfoExportMenu: React.FC<HiringInfoExportMenuProps> = memo(
  function HiringInfoExportMenu({ candidate }) {
    ...
    const handleWord = async () => {
      ...
      setIsOpen(false);
      try {
        await exportHiringInfoWord(candidate);
      } finally {
    ...
    return (
      <div className="relative inline-block text-left" ref={menuRef}>
        <button
          ...
          title="Export Hiring Information"
        >
        ...
        {isOpen && (
          <div className="absolute right-0 mt-1.5 w-48 rounded-2xl bg-white border border-slate-200 shadow-xl z-30 p-1.5 animate-in fade-in zoom-in-95 duration-100">
