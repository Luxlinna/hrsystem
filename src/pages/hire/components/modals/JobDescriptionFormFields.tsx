...
export const JobDescriptionFormFields = memo(function JobDescriptionFormFields({ form, setForm }: Props) {
  ...
  return (
    <div className="rounded-3xl border border-gray-200/90 bg-white shadow-xs overflow-hidden">
        ...
        <div className="bg-white rounded-2xl p-4 border border-blue-100 shadow-2xs">
          <div className="flex items-center justify-between mb-1.5">
            <label className="text-xs font-extrabold text-blue-950 flex items-center gap-1.5">
              <i className="ri-compass-3-line text-blue-600 text-sm" /> 1. Role Purpose & Mission *
            </label>
            <span className="text-[10px] text-gray-400 font-medium">Why this role is required</span>
          </div>
          <textarea
            rows={2}
            required
            ...
            className="w-full p-3 bg-gray-50/80 rounded-xl text-xs text-gray-800 placeholder-gray-400 border border-gray-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#253C7D]/20 focus:border-[#253C7D] transition-all resize-none font-medium"
          />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="bg-white rounded-2xl p-4 border border-emerald-100 shadow-2xs">
            ...
            <textarea
              ...
              className="w-full p-3 bg-gray-50/80 rounded-xl text-xs text-gray-800 placeholder-gray-400 border border-gray-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-600 transition-all font-medium"
            />
          </div>
          ...
          <div className="bg-white rounded-2xl p-4 border border-amber-100 shadow-2xs">
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button
                ...
                className="text-[10px] font-bold text-amber-800 hover:text-amber-900 bg-amber-50 px-2 py-0.5 rounded-md border border-amber-200 cursor-pointer"
              >
                + Bullet
              </button>
            </div>
            <textarea
              ...
              className="w-full p-3 bg-gray-50/80 rounded-xl text-xs text-gray-800 placeholder-gray-400 border border-gray-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-600 transition-all font-medium"
            />
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl p-4 border border-sky-100 shadow-2xs">
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button
                ...
                className="text-[10px] font-bold text-sky-700 hover:text-sky-800 bg-sky-50 px-2 py-0.5 rounded-md border border-sky-200 cursor-pointer"
              >
                + Bullet
              </button>
            </div>
            <textarea
              ...
              className="w-full p-3 bg-gray-50/80 rounded-xl text-xs text-gray-800 placeholder-gray-400 border border-gray-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-600 transition-all font-medium resize-none"
            />
          </div>
          ...
          <div className="bg-white rounded-2xl p-4 border border-purple-100 shadow-2xs flex flex-col justify-between">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-gray-50/80 rounded-xl text-xs text-gray-800 placeholder-gray-400 border border-gray-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-600 transition-all font-medium"
              />
            </div>
