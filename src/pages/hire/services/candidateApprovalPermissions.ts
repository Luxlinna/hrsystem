...
export function evaluateApprovalStepGates(
  ...
  return {
    ceo: {
      key: "ceo",
      stepNumber: 1,
      roleTitle: sigs?.ceo?.title || "CEO / Division Director",
      isApproved: isCeoApproved,
      isLocked: false,
      waitingForRoleTitle: null,
      canUserSign: canUserSignApprovalStep("ceo", role, isAdmin, isBranchAdmin),
      requiresPermissionHint: "Requires BU CEO role or delegated staff permission.",
    },
    hr_manager: {
      key: "hr_manager",
      stepNumber: 2,
      roleTitle: sigs?.hr_manager?.title || "HR and Admin Manager",
      isApproved: isHrApproved,
      isLocked: !isCeoApproved,
      waitingForRoleTitle: "Step 1 (CEO / BU Director)",
      canUserSign: canUserSignApprovalStep("hr_manager", role, isAdmin, isBranchAdmin),
      requiresPermissionHint: "Requires HR Manager role or delegated HR staff permission.",
    },
    division_director: {
      key: "division_director",
      stepNumber: 3,
      roleTitle: sigs?.division_director?.title || "HR&Admin Division Director",
      isApproved: isDirectorApproved,
      isLocked: !isHrApproved,
      waitingForRoleTitle: "Step 2 (HR and Admin Manager)",
      canUserSign: canUserSignApprovalStep("division_director", role, isAdmin, isBranchAdmin),
      requiresPermissionHint: "Requires HR&Admin Division Director permission.",
    },
    chairwoman: {
      key: "chairwoman",
      stepNumber: 4,
      ...
      waitingForRoleTitle: "Step 3 (HR&Admin Division Director)",
      canUserSign: canUserSignApprovalStep("chairwoman", role, isAdmin, isBranchAdmin),
      requiresPermissionHint: "Requires Chairwoman executive authority.",
    },
  };
}
