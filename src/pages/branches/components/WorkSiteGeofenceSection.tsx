...
interface WorkSiteGeofenceSectionProps {
...
export const WorkSiteGeofenceSection = memo(function WorkSiteGeofenceSection({
  form,
  setForm,
  addressLookup,
  setAddressLookup,
    ...
    <div className="border-t border-gray-100 pt-5">
      ...
      <div className="flex gap-2 mb-2">
        <input
          ...
          placeholder="Or type an address or site name to look up..."
        ...
        <button
          ...
          className="px-3.5 py-2.5 border border-gray-200 rounded-lg text-[12px] font-semibold text-gray-700 hover:bg-gray-50 disabled:opacity-60 cursor-pointer whitespace-nowrap"
        >
      ...
      <p className="text-[11px] text-gray-400 mt-1.5">
        Leave latitude/longitude blank to inherit location checks from the main branch.
      </p>
    </div>
  );
});
