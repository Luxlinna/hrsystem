        ...
        <div className="md:col-span-9 space-y-2">
          <div className="grid grid-cols-3 gap-3">
            <div className="p-3 bg-slate-50 border border-slate-200/80 rounded-xl text-center">
              <div className="text-[10px] font-bold text-slate-500 uppercase">{activeTypeCfg.code} Balance</div>
            ...
            <div className="p-3 bg-amber-50/70 border border-amber-200/80 rounded-xl text-center">
              <div className="text-[10px] font-bold text-amber-700 uppercase">{activeTypeCfg.code} Used</div>
            ...
            <div className="p-3 bg-emerald-50/70 border border-emerald-200/80 rounded-xl text-center">
              <div className="text-[10px] font-bold text-emerald-700 uppercase">{activeTypeCfg.code} Available</div>
