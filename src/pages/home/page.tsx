...
const QUICK_ACTIONS = [
  { label: "Log Attendance", icon: "ri-fingerprint-line", path: "/self-service", color: "bg-emerald-500", note: "Clock in / out" },
  { label: "Submit Leave", icon: "ri-calendar-event-line", path: "/self-service", color: "bg-amber-500", note: "Request time off" },
  { label: "View Payslip", icon: "ri-money-dollar-circle-line", path: "/self-service", color: "bg-[#0D7377]", note: "Your payslips" },
  { label: "New Employee", icon: "ri-user-add-line", path: "/employees", color: "bg-violet-500", note: "Add to directory" },
  { label: "Notifications", icon: "ri-notification-3-line", path: "/notifications", color: "bg-rose-500", note: "Check alerts" },
];
