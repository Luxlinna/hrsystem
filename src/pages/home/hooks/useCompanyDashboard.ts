...
export function useCompanyDashboard() {
  ...
  // Partner Privacy Rule: Super Admin or any user CANNOT access other partner branches' dashboard.
  ...
  const loadAllData = useCallback(async () => {
    // If user does not belong to this branch, block dashboard
    ...
    const [
      ...
      supabase.from("offboarding_requests").select("last_day, created_at, branch_id"),
    ]);
